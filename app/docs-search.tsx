...
const japaneseSearchEntries: SearchEntry[] = [
  ...
  { title: "対応データベース", location: "Architecture", href: "/architecture#supported-databases", keywords: "SQL Server MySQL PostgreSQL 対応バージョン" },
  { title: "セキュリティと運用権限", location: "Architecture", href: "/architecture#security", keywords: "暗号化 接続情報 Key Ring HTTPS DB権限" },
  ...
  { title: "デモを起動する", location: "Getting Started", href: "/getting-started#run-demo", keywords: "Windows 10 dotnet Aspire Docker 起動" },
...
const englishSearchEntries: SearchEntry[] = [
  ...
  { title: "Supported databases", location: "Architecture", href: "/en/architecture#supported-databases", keywords: "SQL Server MySQL PostgreSQL supported versions" },
  { title: "Security and operational access", location: "Architecture", href: "/en/architecture#security", keywords: "encryption connection data Key Ring HTTPS database permissions" },
  ...
  { title: "Run the demo", location: "Getting Started", href: "/en/getting-started#run-demo", keywords: "Windows 10 dotnet Aspire Docker start" },
  ...
  return (
    <div className="searchControl" ref={rootRef}>
      <form className="search" role="search" onSubmit={handleSubmit}>
        <label className="srOnly" htmlFor={inputId}>{locale === "ja" ? "ドキュメントを検索" : "Search the documentation"}</label>
        <input
          ref={inputRef}
          id={inputId}
          type="search"
